...
class __TwigTemplate_054dc9c685a31c23af1479b763b715d381619654ea514dafb61cc1cf01f3cc82 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"descriptionBest\">
        ...
        // line 6
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 6, $this->source); })()), "subtitle", [], "any", false, false, false, 6), "html", null, true);
        echo " </span></p>


        <p><span class=\"product-price\"> ";
        // line 9
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 9, $this->source); })()), "price", [], "any", false, false, false, 9) / 100), 2, ",", "."), "html", null, true);
        echo " € </span></p>
        <div>
            ";
        // line 11
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 11, $this->source); })()), "category", [], "any", false, false, false, 11));
...
";
    ...
    {
        return array (  85 => 14,  76 => 12,  72 => 11,  67 => 9,  61 => 6,  57 => 5,  52 => 3,  46 => 2,  43 => 1,);
    }
...
", "product/single_product.html.twig", "/Users/cedricdebroux/Documents/norris_transport_it /Projects/tiny_and_pretty_symfony/Tiny_and_Pretty/templates/product/single_product.html.twig");
    }
}
