...
class __TwigTemplate_7b7801dd3000e166fda9b4c61d2de583d12af931a9ac85ebfaac5988aa5ac625 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo "
            ...
            <p> ";
        // line 18
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 18, $this->source); })()), "size", [], "any", false, false, false, 18), "html", null, true);
        echo "</p>
            ...
            ";
        // line 23
        if ((twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 23, $this->source); })()), "soldout", [], "any", false, false, false, 23) == false)) {
            // line 24
            echo "                <button
                    ...
                    <a href=\"";
            // line 27
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("add_to_cart", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 27, $this->source); })()), "id", [], "any", false, false, false, 27)]), "html", null, true);
    ...
    <div class=\"container-fluid col-sm-6 col-md-6 col-lg col-xl col-xxl bestproducts\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            ...
            echo "                <div class=\"col\">
                    ";
            // line 138
            $this->loadTemplate("product/single_product.html.twig", "product/show.html.twig", 138)->display($context);
            // line 139
            echo "                </div>
            ";
            ++$context['loop']['index0'];
...
";
    ...
    {
        return array (  287 => 141,  272 => 139,  270 => 138,  267 => 137,  250 => 136,  144 => 32,  140 => 30,  134 => 27,  129 => 24,  127 => 23,  119 => 18,  114 => 16,  108 => 13,  104 => 12,  100 => 11,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    <div class=\"row\">
        <div class=\"container-fluid col-md-4 ml-5 mb-5 ml-sm-0\">
            <img src=\"/uploads/{{ product.illustration }}\" alt=\"{{ product.name }}\" class=\"img-fluid zoomimg mt-5 ml-5\">
        </div>
        <div class=\"col-md-7 my-auto aside-description mt-sm-5 mx-sm-auto\">
