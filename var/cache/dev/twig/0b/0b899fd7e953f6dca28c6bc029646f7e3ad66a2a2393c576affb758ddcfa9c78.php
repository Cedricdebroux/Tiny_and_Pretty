...
/* header.html.twig */
class __TwigTemplate_253f8e55c1bf75d9ea087cc8830ac16b4069d13687eff6c98ece2c7dd97ac105 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav class=\"navbar navbar-expand-md navbar-expand-lg navbar-light bg-light justify-content-between static-top\">
        ...
        echo "\"><h5 class=\"text-center mt-5 mb-5 title_drop\">LA MODE</h5></a>
        ...
        echo "\"><h5 class=\" mt-5 mb-5 text-center title_drop\">À LA MAISON</h5></a>
                                <div class=\"d-flex  flex-row p-2\">
        ...
        <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
            <ul class=\"navbar-nav  ml-auto ms-auto  mt-2 mt-lg-0\">
                <li class=\"nav-item dropdown\">
                    ...
                    <div class=\"dropdown-menu text-left\" aria-labelledby=\"navbarDropdown\" data-boundary=\"overflow\">
                        <a href=\"{{ relative_path('/Mode') }}\"><h5 class=\"text-center mt-5 mb-5 title_drop\">LA MODE</h5></a>
                        <div class=\"d-flex  flex-row p-2\">
                ...
                <li>
                    ...
                    <ul class=\"navbar-nav mr-auto\">
                        <li class=\"nav-item dropdown\">
                            ...
                            <div class=\"dropdown-menu text-left\" aria-labelledby=\"navbarDropdown\">
                                <a href=\"{{ relative_path('/maison') }}\"><h5 class=\" mt-5 mb-5 text-center title_drop\">À LA MAISON</h5></a>
                                <div class=\"d-flex  flex-row p-2\">
                                    <div class=\"p-2 bd-highlight\">
                                        <h5 class=\"categories-nav pl-3 \">À TABLE ! </h5>
