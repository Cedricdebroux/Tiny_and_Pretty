...
class __TwigTemplate_c2445eba72131474bd88140f1964cb88ed3c7fc020352c7c38546d0f7a094b8b extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        $context["__internal_03b6a7ac2e9ff73b25a52999f0e1fe58b866821e169cb567537a2d4752f78c21"] = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["ea"]) || array_key_exists("ea", $context) ? $context["ea"] : (function () { throw new RuntimeError('Variable "ea" does not exist.', 1, $this->source); })()), "i18n", [], "any", false, false, false, 1), "translationDomain", [], "any", false, false, false, 1);
        // line 2
...
(isset($context["__internal_03b6a7ac2e9ff73b25a52999f0e1fe58b866821e169cb567537a2d4752f78c21"]) || array_key_exists("__internal_03b6a7ac2e9ff73b25a52999f0e1fe58b866821e169cb567537a2d4752f78c21", $context) ? $context["__internal_03b6a7ac2e9ff73b25a52999f0e1fe58b866821e169cb567537a2d4752f78c21"] : (function () { throw new RuntimeError('Variable "__internal_03b6a7ac2e9ff73b25a52999f0e1fe58b866821e169cb567537a2d4752f78c21" does not exist.', 1, $this->source); })()));
                        // line 11
                        echo "
                    </div>
                ";
...
{% if app.session is not null and app.session.started %}
    ...
    {% endif %}
{% endif %}
", "@EasyAdmin/flash_messages.html.twig", "/Users/cedricdebroux/Documents/norris_transport_it /Projects/tiny_and_pretty_symfony/Tiny_and_Pretty/vendor/easycorp/easyadmin-bundle/src/Resources/views/flash_messages.html.twig");
    }
}
