 ...
 */
final class Version20210812090425 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products ADD soldout TINYINT(1) NOT NULL, DROP category_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products ADD category_id INT NOT NULL, DROP soldout');
